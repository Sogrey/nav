...
const c: IConfig = {
  // [必填], 请填写您的仓库地址
  gitRepoUrl: 'https://github.com/Sogrey/nav.git',
  ...
  footerContent: `
    ...
    <div>Copyright © 2015-2021 sogrey.top, All Rights Reserved</div>
  `,
  ...
  baiduStatisticsUrl: 'https://hm.baidu.com/hm.js?cd6a6fe326d3b863475132f284675cc3',
